...
COLUMNS = {
    ...
    'CVRefereeing': ['creators', 'title', 'magazineRef', 'othermagazine',
                     'worksPerYear', 'sede'],
    'CVEventOrg': ['title', 'event_date', 'country', 'city', 'numberOfDays', 'institutions',
...
class ReportView(BrowserView):
    ...
    def getMatchedItems(self):
        ...
        try:
            ...
            sede = ['C.U.', 'Cuernavaca', 'Juriquilla', 'Oaxaca']
    ...
    def usersBySede(self, ids):
        ...
        users ={'C.U.': [], 'Cuernavaca': [], 'Juriquilla': [], 'Oaxaca': []}
        for brain in brains:
            ...
            elif 'Oaxaca' in brain.getClassificationNames:
                users['Oaxaca'].append(brain.id)
